...
function SegmentsAndLabel() {
    ...
    useEffect(() => {
        ...
        fetch('https://volume-classification-server.vercel.app:5000/api/images')
            ...
            .then(data => {
                ...
                const urls = filteredData.map(filename => `https://volume-classification-server.vercel.app:5000/uploads/${filename}`);
                setImageUrls(urls);
            })
            .catch(error => {
    ...
    const deleteImage = () => {
        ...
        fetch(`https://volume-classification-server.vercel.app:5000/api/delete/${filename}`, {
            method: 'DELETE',
        })
            .then(response => response.json())
            .then(data => {
    ...
    const handleEdit = async () => {
        if (newTitle.trim() !== '') {
            ...
            const response = await fetch(`https://volume-classification-server.vercel.app:5000/api/edit`, {
                method: 'POST',
                headers: {
